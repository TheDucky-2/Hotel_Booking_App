...
const AllRooms = () => {
    ...
    const sortOptions = ["Price Low to Hight", "Price High to Low", "Newest First"]
    ...
    // Function to check if room matches the selected room type
    ...
    const matchPriceRange = (room) => {
        return selectedFilters.priceRange.length === 0 || selectedFilters.roomType.some(range => {
            ...
            {filteredRooms.map((room)=>(
                ...
                <div key={room._id}className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    ...
                    <div>
                        ...
                        {/** Room Amenities*/}
                        <div className='flex fex-wrap items-center mt-3 mb-6 gap-4 '>
                        ...
                        <p className='text-cl font-medium text-gray-700'> ${room.pricePerNight} /night</p>
                    </div>
                </div>
            ))}
        </div>
