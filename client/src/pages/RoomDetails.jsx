...
const RoomDetails = () => {
  ...
  const checkAvailability = async() => {
    try{
      // check if Check-in Date greater than Check-Out date
  ...
  // onSubmitHandler func to check availability & book the room
  ...
  <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        gap-4 md:gap-10 text-gray-500'>
          ...
          <div className='flex flex-col'>
                <label htmlFor='checkInDate' className='font-medium'> Check-In  </label>
                  <input onChange={(event)=> setCheckInDate(event.target.value)} min={new Date().toISOString().split('T')[0]}
          ...
          <div className='flex flex-col'>
                <label htmlFor='checkOutDate' className='font-medium'> Check-Out  </label>
                  <input  onChange={(event)=> setCheckOutDate(event.target.value)} min={checkInDate} disabled={!checkInDate}
          ...
          <div className='flex flex-col'>
                <label htmlFor='guests' className='font-medium'> Guests </label>
                  <input onChange={(event)=> setGuests(event.target.value)} value = {guests}
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
      <p>
        Guests will be allocated rooms on the ground floor according to availability.
        <br></br>You get a comfortable Two bedroom apartment that has a true city feeling.
        <br></br>The price quotes is for two guests. <br></br>
