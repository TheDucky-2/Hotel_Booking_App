...
const Dashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try{
            ...
            const {data} = await axios.get("/api/booking/hotel", {headers:{
...
<div>
        ...
        subTitle='Monitor your room listings, track bookings and analyze revenue – all in once place.
                ...
                {dashboardData.bookings.map((item, index) => (
                    <tr key={index}>
                        ...
                        <td className='py-3 px-4 text-gray-700 border-t border-gray-300 flex'>
                            ...
                            ${item.isPaid ? 'bg-green-200 text-green-800' : 'bg-amber-200 text-yellow-800'}`} >
